...
public class ItemReaderV0 implements RegisterableReader<Item>
{
    ...
    public Item read(JsonObject object, Identifier identifier)
    {
        ...
        return Registry.register(Registry.ITEM, identifier, new Item(settings));
    }

    @Override
    public Item read(JsonObject object) { throw new UnsupportedOperationException("Reader#read method not supported for item readers."); }
}